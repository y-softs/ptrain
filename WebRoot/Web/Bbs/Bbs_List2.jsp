...
<head>
    ...
    <script type="text/javascript">
		...
		//查询数据
		function querydata(){
		    document.form2.action = "<c:url value='/pt/bbs/listtrainbbs_share.shtml'/>";
		...
		function reprint(id){
			var param = "?ptrainBbsBean.id="+id;
				param +="&setpage=Bbs_Win2&querymap.kind=0";
        ...
        <div class="content">
        	<div class="leftsidebar">
                ...
                <ul class="ulsidebar">
                    ...
                    <li><a href="<c:url value='/pt/bbs/listtrainbbs_share.shtml'/>"><label class="selected"></label>资源共享</a></li>
            ...
            <div class="list">
                ...
                <div class="list-con">
                    ...
                    <div class="page_bar">
                    	<ul class="page_record"><nsoft:pages record="%{record}" tagpage="%{tagpage}" total="%{total}" formname="%{'form2'}" url="%{'listtrainbbs_share.shtml'}"/></ul>
                    </div>
                </div>
            </div>  
        </div>              
