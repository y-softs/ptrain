...
<head>
    ...
    <script type="text/javascript">
		...
		function validateInfo(){			
			...
			$("#title").attr("dataType","Require").attr("msg","规章名称<fmt:message key="format.null" bundle="${bms}"/>");//验证附件
			$("#content").attr("dataType","Require").attr("msg","规章简介<fmt:message key="format.null" bundle="${bms}"/>");//验证附件
			var jsonArr = [{"key":"upfile","error":"文件路径不能为空！"}];
