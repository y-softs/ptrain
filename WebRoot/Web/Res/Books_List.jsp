...
<head>
	...
	<script language="javascript">
		...
		//提交查询数据列表
		function querydata(){
			document.form2.action="<c:url value='/pt/con/listcontentbooks.shtml'/>";
        ...
        <div class="content">
            ...
            <div class="list">
                ...
                <div class="list-con" style="clear:both;">
                        ...
                        <c:forEach items="${dataList}" var="d" varStatus="order">
                       	<tr>                          		
                             <td align="left" style="padding-left:10px;">
                             	<a href="<c:url value='/pt/con/booksview.shtml'/>?pkId=${d.id }&fatherid=${fatherid }&typeid=${typeid }&KIND=${KIND }" class="title" target="_blank" title="${d.title }">
	                             	<c:choose>
                    ...
                    <div class="page_bar">
                    	<ul class="page_record"><nsoft:pages record="%{record}" tagpage="%{tagpage}" total="%{total}" formname="%{'form2'}" url="%{'listcontentbooks.shtml'}"/></ul>
                    </div>
                </div>
            </div>  
        </div>              
