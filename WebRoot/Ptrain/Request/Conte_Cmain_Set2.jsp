...
<div class="container">
    ...
    <!-- 标题区域 --->
    <div class="titleArea">
        <div class="titleClass">培训中心加菜-导入</div>
    </div>
    <!-- 分隔符 --->
    <div class="lineSpac"></div>
    <!-- 查询条件 --->
       ...
       <table class="editTable">
            ...
            <tr>
                ...
                <td class="right">
                    ...
                    <a href="JavaScript:downLoad('Table01.xls','/Ptrain/Request/Download/')">&gt;&gt;&nbsp;格式下载</a>
                </td>            
            </tr>
            <tr>
...
<script type="text/javascript">
	...
	//返回
	function goBack(){
	    document.form1.action="<c:url value='/Ptrain/Req/listptrainreq_com.shtml' />";
	    document.form1.submit();
	}
    //下载文件 
