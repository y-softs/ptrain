...
<script language="javascript">
    ...
    var cols = [
        ...
        { title:'操作', name:'' ,width:90, align:'center', renderer: function(val,item,rowIndex){
    ...
    function setData(id,fun){
    	var paramV="querymap.unitid=${querymap.unitid}&ptrainReqtempBean.id="+id+"&querymap.reqtype=${querymap.reqtype}&querymap.specid="+$("#specid").val()+"&setpage=/Ptrain/Request/Conte_Emain_Set1.jsp&fun="+fun;
        parent.$.jBox.open("iframe:<c:url value="/Ptrain/Req/setptrainreqtempwin.shtml"/>?"+paramV, 
        (fun == 1?"新增":"兼职教师加菜-修改"), 900, 455, { buttons: {}});
    }
    //删除
    function delData(id){
    	id = id || "-1";
