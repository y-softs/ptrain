        ...
        <table class="editTable">
           ...
           <tr>
               ...
               <td class="right">
           		...
           		<c:if test="${REQ_USER!=ptrainReqBean.reqtype}">
                   <div id="upfile_span">
           ...
           <c:if test="${REQ_COM==ptrainReqBean.reqtype||REQ_EXP==ptrainReqBean.reqtype}">
           <tr>
...
<script type="text/javascript">
	$(function(){
		<c:if test="${REQ_USER!=ptrainReqBean.reqtype}">operFile();</c:if>
		...
		if(${REQ_COUR==ptrainReqBean.reqtype}){
		//绑定 培训师
		$("input[name='ptrainReqBean.teacher']").attr("fv-empty","false").attr("fv-empty-msg","课件制作人<fmt:message key="format.null" bundle="${bms}"/>")
