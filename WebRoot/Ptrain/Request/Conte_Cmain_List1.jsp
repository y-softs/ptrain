...
<div id="container">
    ...
    <div class="mySearchMain" id="mySearchMain">
        <form method="post" name="form" id="form1" action="">
    		...
    		<input type="hidden" name="listpage" value="/Ptrain/Request/Conte_Cmain_List1.jsp"/>
    		<input type="hidden" name="listtemppage" value="/Ptrain/Request/Conte_Cmain_List2.jsp"/>
    		<input type="hidden" name="settemppage" value="/Ptrain/Request/Conte_Cmain_Set2.jsp"/>
...
<script language="javascript">
    ...
    function setData(id,fun){
    	var paramV="querymap.unitid=${querymap.unitid}&ptrainReqBean.id="+id+"&querymap.reqtype=${querymap.reqtype}&querymap.specid="+$("#specid").val()+"&setpage=/Ptrain/Request/Conte_Cmain_Set1.jsp&fun="+fun;

        parent.$.jBox.open("iframe:<c:url value="/Ptrain/Req/setptrainreq.shtml"/>?"+paramV, 
        (fun == 1?"培训中心加菜-新增":"培训中心加菜-修改"), 900, 440, { buttons: {}});
    }
    //详细页面
