...
<div id="container">
    ...
    <!-- 标题区域 --->
    <div class="titleArea">
        <div class="titleClass">书籍上传[<span class="switchSearch">数据搜索</span>]</div>
    </div>
    <!-- 分隔符 --->
    <div class="lineSpac"></div>
    <!-- 查询条件 --->
    <div class="mySearchMain" id="mySearchMain">
        <form method="post" name="form" id="form1" action="">
             ...
             <input type="hidden" name="listpage" value="/Ptrain/Resou/Books_Esta_List.jsp" id="listpage" />
...
<script type="text/javascript">
    ...
    function setData(id,fun){
        ...
        (fun == 1?"书籍上传-新增":"书籍上传-修改"), 700, 390, { buttons: {}});
    } 
    //详细页面
