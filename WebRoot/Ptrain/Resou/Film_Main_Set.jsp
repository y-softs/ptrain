...
<div class="editContainer">
    <form name="form1" id="form1" action="" method="post">
        <table class="editTable">
            ...
            <c:if test="${empty ptrainContentBean.id}">
            <tr>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input type="hidden" name="ptrainContentBean.usesign" value="${not empty ptrainContentBean.usesign?ptrainContentBean.usesign:'1'}"/>
                    <!-- 回帖 -->
