...
<div class="container">
	...
	<script type="text/javascript">
		...
		function setDataWin(id){
			var url = "<c:url value='/Ptrain/Cours/setptraincourschk.shtml'/>?ptrainCoursBean.id="+id;
			url+="&querymap.unitid=${querymap.unitid}";
			url+="&setpage=/Ptrain/Resou/Cours_Gchk_Win3.jsp";
        	parent.$.jBox.open("iframe:"+url, ("归口审核-修改"), 650, 480, { buttons: {}});
		}
	    ...
	    var cols = [
	        ...
	        { title:'课件名称', name:'title' ,width:290, align:'left',sortName:'co.title,co.id',sortStatus:'asc',sortable: true, renderer: function(val,item,rowIndex){
	    ...
	    var paramsV={
	    	...
	    	'ptrainCoursBean.id':'${ptrainCoursBean.id}'
	    }
	    var mmg = $('#dataTable').mmGrid({
	        ...
	        width:'98%',
	        cols: cols,
	        url: '<c:url value="/Ptrain/Cours/listptraincoursbyids.shtml"/>',
	        params:paramsV,
	        method: 'post',
			nowarp:true
	    });
