...
<div id="container">
    ...
    <!-- 标题区域 --->
    <div class="titleArea">
        <div class="titleClass">三问专业类别[<span class="switchSearch">数据搜索</span>]</div>
    </div>
    <!-- 分隔符 --->
    <div class="lineSpac"></div>
    <!-- 查询条件 --->
    	...
    	<form method="post" name="form" id="form1" action="">
	          ...
	          `	<input type="text" name="keyword" id="b_keyword" value="${keyword}" />
	            <input type="button" name="search" id="b_search" class="btn btn-primary" onclick="toSearch();" value="查询" />
	          <input type="hidden" name="setpage" id="b_setpage" value="${setpage}" />
    ...
    <div class="gridDiv">
        <div id="dataPagi"></div>
        <div id="btnGroup">
        	<button class="btn btn-info" id="btn_impExcel">导入Excel</button>
...
<script type="text/javascript">
	...
	var url = '<c:url value='/Ptrain/Code/listptraincode_spec.shtml'/>';
	...
	$(function(){
    	...
    	//导入Excel
    	$("#btn_impExcel").bind("click",function(){
			$("#b_setpage").val("Three_Set2.jsp");
			$("#form1").attr("action","<c:url value='/Ptrain/Code/setptraincode.shtml'/>").trigger("submit");
    	});
